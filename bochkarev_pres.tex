...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org946160c}]{A motivating example: t-UFLP}
\begin{columns}
\begin{column}{0.2\columnwidth}
...
\end{frame}
\begin{frame}[label={sec:orgf7e70a2}]{A motivating example: t-UFLP}
\begin{columns}
\begin{column}{0.2\columnwidth}
\includegraphics[height=0.8\textheight]{./img/tUFLP.png}
\end{column}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdf3696c}]{In this section:}
\begin{itemize}
...
\label{sec:orgdb842d9}
\begin{frame}[label={sec:org9960267}]{BDD alignment problem}
...
\end{frame}
\begin{frame}[label={sec:orge567fb3}]{Research context}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org5b69dea}]{The idea: let's just consider bounds!}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3e0f102}]{Bounds for sift operations}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2e09f3}]{Plan of attack}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org26992a7}]{We use several properties to design a solution}
\begin{columns}
...
\end{frame}
\begin{frame}[label={sec:org13182b7}]{\ldots{} and bound.}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2ddc9a5}]{A note on the lower bound}
\begin{columns}
...
\label{sec:org6b46b95}
\begin{frame}[label={sec:org0c982c1}]{Numerical experiments: strategy}
\begin{itemize}
...
\begin{frame}[label={sec:org5b48af8}]{Simplified problem: optima}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org44c0bb5}]{Simplified problem: heuristics}
\centering
\includegraphics[width=\textwidth]{./img/simpl_heuristics.eps}
\end{frame}
\begin{frame}[label={sec:org7704bf1}]{Objectives relative to the ``greedy sifts''}
\centering
\includegraphics[width=\textwidth]{./img/orig_obj_histograms.eps}
\end{frame}
\begin{frame}[label={sec:orge037554}]{Scaling with the problem size}
\centering
\includegraphics[width=\textwidth]{./img/orig_runtimes.eps}
\end{frame}

\begin{frame}[label={sec:orga5ed5d0}]{Simplified vs. Original problem solutions}
\centering
\includegraphics[width=\textwidth]{./img/heuristic_simscore.eps}
\end{frame}
\begin{frame}[label={sec:org46a69ef}]{Effects of the problem structure}
\centering
...
\label{sec:org14763fc}
\subsection*{Section outline}
\label{sec:org8bd4904}
\tableofcontents[currentsection]
\subsection{Problem description}
\label{sec:org8199fde}
\begin{frame}[label={sec:org4b67041}]{A variant of the Facility Location Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org5799c4e}
\begin{frame}[label={sec:org98f4525}]{Problem formulation}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeef238c},t]{How to build the cover BDD}
\begin{columns}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8da800b},t]{How to build the type BDD}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\centering
...
\end{frame}
\subsection{Numerical experiments}
\label{sec:org0315ea7}
\begin{frame}[label={sec:orge9a195c}]{Comparing runtimes (random instances)}
\includegraphics[width=\textwidth]{./img/tUFLP_runtimes_overview.eps}
\end{frame}
\begin{frame}[label={sec:org0eb30a5}]{Runtimes breakdown}
\includegraphics[width=\textwidth]{./img/tUFLP_runtimes_breakdown.eps}
\end{frame}
\begin{frame}[label={sec:org22ec195}]{Alignment heuristic performance vs. problem structure}
\includegraphics[width=\textwidth]{./img/various_simpl_vs_min.eps}
\end{frame}
\subsection*{t-UFLP summary}
\label{sec:orgcb554d7}
\begin{frame}[label={sec:org5d544d5}]{Summary on t-UFLP}
\begin{itemize}
...
\label{sec:org0c2cdfe}
\subsection*{Section outline}
\label{sec:orgeb74010}
\tableofcontents[currentsection]
...
\begin{frame}[label={sec:org716002d}]{A game of ``interdiction'': formulation}
...
\label{sec:org5ee59f7}
\begin{frame}[label={sec:org35c1579}]{Monte Carlo Tree Search}
\begin{itemize}
...
\label{sec:org4faddba}
\begin{frame}[label={sec:org348d859}]{The ``game tree''}
...
\begin{frame}[label={sec:orgf774806}]{Phase 1. Selection}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:orgb4e8e81}]{Phase 2. Expansion}
% expansion
\begin{minipage}{0.3\textwidth}
\begin{tikzpicture}[%level distance=5mm,
level 1/.style={level distance=10mm,sibling distance=12mm},
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:orgb759051}]{Phase 3. Roll-outs}
% roll-outs
\begin{minipage}{0.3\textwidth}
\begin{tikzpicture}[%level distance=5mm,
level 1/.style={level distance=10mm,sibling distance=12mm},
...
\begin{frame}[label={sec:orgdf49ba0}]{Phase 4. Backpropagation}
% backpropagation
\begin{minipage}{0.3\textwidth}
\begin{tikzpicture}[%level distance=5mm,
level 1/.style={level distance=10mm,sibling distance=12mm},
...
\begin{frame}[label={sec:org09e44ef}]{The Algorithm}
...
\begin{frame}[label={sec:orgd376954}]{There are several secret ingredients}
\begin{figure}
\includegraphics[width=\textwidth]{img/ingredient.jpg}
\end{figure}
\end{frame}

\begin{frame}[label={sec:org3baf649}]{SI-1. How to select?}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org96bd5a6}]{SI-2. How to prune?}
...
\begin{frame}[label={sec:org54d3ab8}]{Pre-defined instances}
\begin{figure}
\includegraphics[width=\textwidth]{img/fig_known.png}
\end{figure}
\end{frame}
\begin{frame}[label={sec:org6a0d9be}]{Random instances (snapshot)}
\begin{figure}
\includegraphics[width=\textwidth]{img/fig_bounds.png}\vspace{0.5ex}
\includegraphics[width=\textwidth]{img/fig_runtimes.png}
\end{figure}
\end{frame}
\begin{frame}[label={sec:orge0d06c7}]{Convergence profiles}
...
\end{minipage}
\end{frame}
\begin{frame}[label={sec:org0247a53}]{A remark: that's not just different runs}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\begin{frame}[label={sec:orgf3db83b}]{Play-out vs. first-move strategy}
\includegraphics[width=\textwidth]{img/courage.eps}
\end{frame}
\subsection{On correctness}
\label{sec:orged8420a}
\begin{frame}[label={sec:org6005134}]{Why does it work? (A sketch on ``correctness'')}
...
\begin{frame}[label={sec:orgae903ac}]{Why in the world the tree is finite?}
\begin{columns}
